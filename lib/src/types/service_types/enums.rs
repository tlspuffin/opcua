...
impl BinaryEncoder<DataSetFieldFlags> for DataSetFieldFlags {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(DataSetFieldFlags::from_bits_truncate(i16::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<DataSetFieldContentMask> for DataSetFieldContentMask {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(DataSetFieldContentMask::from_bits_truncate(i32::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<UadpNetworkMessageContentMask> for UadpNetworkMessageContentMask {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(UadpNetworkMessageContentMask::from_bits_truncate(
            i32::decode(stream, decoding_options)?,
        ))
    }
}
...
impl BinaryEncoder<UadpDataSetMessageContentMask> for UadpDataSetMessageContentMask {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(UadpDataSetMessageContentMask::from_bits_truncate(
            i32::decode(stream, decoding_options)?,
        ))
    }
}
...
impl BinaryEncoder<JsonNetworkMessageContentMask> for JsonNetworkMessageContentMask {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(JsonNetworkMessageContentMask::from_bits_truncate(
            i32::decode(stream, decoding_options)?,
        ))
    }
}
...
impl BinaryEncoder<JsonDataSetMessageContentMask> for JsonDataSetMessageContentMask {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(JsonDataSetMessageContentMask::from_bits_truncate(
            i32::decode(stream, decoding_options)?,
        ))
    }
}
...
impl BinaryEncoder<PermissionType> for PermissionType {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(PermissionType::from_bits_truncate(i32::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<AccessLevelType> for AccessLevelType {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(AccessLevelType::from_bits_truncate(u8::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<AccessLevelExType> for AccessLevelExType {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(AccessLevelExType::from_bits_truncate(i32::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<EventNotifierType> for EventNotifierType {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(EventNotifierType::from_bits_truncate(u8::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<AccessRestrictionType> for AccessRestrictionType {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(AccessRestrictionType::from_bits_truncate(i16::decode(
            stream,
            decoding_options,
        )?))
    }
...
impl BinaryEncoder<AttributeWriteMask> for AttributeWriteMask {
    ...
    fn decode<S: Read>(stream: &mut S, decoding_options: &DecodingOptions) -> EncodingResult<Self> {
        Ok(AttributeWriteMask::from_bits_truncate(i32::decode(
            stream,
            decoding_options,
        )?))
    }
